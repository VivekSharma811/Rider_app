...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void signUpAndAuthenticateRider() async {
    User? currentUser;
  ...
  Future addUserToDB(User currentUser) async {
    FirebaseFirestore.instance.collection("riders").doc(currentUser.uid).set({
      ...
      "riderProfilePicture": riderImageUrl,
    ...
    // Save data locally
    await sharedPreferences!.setString("riderUID", currentUser.uid);
    await sharedPreferences!.setString("riderName", nameController.text.trim());
    await sharedPreferences!.setString("riderProfilePicture", riderImageUrl);
    await sharedPreferences!.setString("riderEmail", currentUser.email.toString());
  }
